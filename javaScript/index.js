...
const new_navbar = document.getElementById('new_navbar_list');
...
function close(){
  ...
  new_navbar.style.display = 'block';
...
function snow() {
    ...
    for (var i = 0; i < flakeCount; i++) {
        ...
        ctx.fillStyle = "rgba(25,55,25,)" + flake.opacity + ")";
        flake.y += flake.velY;
        flake.x += flake.velX;
